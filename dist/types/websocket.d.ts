import { ChunkInfo, DataPoint } from './api';
/**
 ...
 */
export type IncomingMessage = ConnectedMessage | PongMessage | InitialDataResponseMessage | HistoryResponseMessage | DataUpdateMessage;
/**
 * Union of all outgoing WebSocket message types.
 */
export type OutgoingMessage = PingMessage | GetInitialDataMessage | RequestHistoryMessage;
/**
